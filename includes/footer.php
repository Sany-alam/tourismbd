                    ...
                    <div class="row justify-content-xl-between">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
                            ...
                            <ul class="list-group list-group-flush list-group-borderless mb-0">
                                ...
                                <li><a class="list-group-item list-group-item-action text-decoration-on-hover" href="https://madrasthemes.github.io/mytravel-html/html/others/terms-conditions.html">Privacy Statement</a></li>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
                            ...
                            <!-- List Group -->
                            <ul class="list-group list-group-flush list-group-borderless mb-0">
                                <li><a class="list-group-item list-group-item-action text-decoration-on-hover" href="https://madrasthemes.github.io/mytravel-html/html/others/about.html">Investor Relations</a></li>
