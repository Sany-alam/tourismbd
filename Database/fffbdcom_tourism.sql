...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2020 at 11:12 AM
...
--
-- Table structure for table `gallery_jayed`
--

CREATE TABLE `gallery_jayed` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `gallery_jayed`
--

INSERT INTO `gallery_jayed` (`id`, `place_name`, `image_name`) VALUES
...
--
-- Indexes for table `gallery_jayed`
--
ALTER TABLE `gallery_jayed`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `gallery_jayed`
--
ALTER TABLE `gallery_jayed`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
